...
{
	class ApproachTargetStateMachine : public EARS::Framework::AnimateStateMachine
	{
	public:

		ApproachTargetStateMachine() = delete;
		ApproachTargetStateMachine(uint32_t TableID, EARS::StateMachineSys::StateMachineParams* SMParams);
		virtual ~ApproachTargetStateMachine();
		...
		static EARS::StateMachineSys::StateMachine* S_ApproachTargetStateMachine_FactoryFn(unsigned int InID, EARS::StateMachineSys::StateMachineParams* InSMParams);
	};
}
